...
/**
 * This is the model class for table "tblc_funcion".
 *
 * The followings are the available columns in table 'tblc_funcion':
...
class Funcion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_finalidad', 'numerical', 'integerOnly'=>true),
			array('descripcion', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_funcion, descripcion, id_finalidad', 'safe', 'on'=>'search'),
		);
	}
