...
/**
 * This is the model class for table "tblc_ambito".
 *
 * The followings are the available columns in table 'tblc_ambito':
...
class Ambito extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_ambito, clave, descripcion', 'safe', 'on'=>'search'),
		);
	}
