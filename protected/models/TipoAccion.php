...
/**
 * This is the model class for table "tblc_tipo_accion".
 *
 * The followings are the available columns in table 'tblc_tipo_accion':
...
class TipoAccion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tipo_accion, nombre, descripcion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TipoAccion the static model class
	 */
