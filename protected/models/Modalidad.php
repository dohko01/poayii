...
/**
 * This is the model class for table "tblc_modalidad".
 *
 * The followings are the available columns in table 'tblc_modalidad':
...
class Modalidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_modalidad, clave, nombre', 'safe', 'on'=>'search'),
		);
	}
