...
/**
 * This is the model class for table "tblc_meta_nacional".
 *
...
class MetaNacional extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_meta_nacional, descripcion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MetaNacional the static model class
	 */
