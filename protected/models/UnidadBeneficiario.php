...
/**
 * This is the model class for table "tblc_unidad_beneficiario".
 *
...
class UnidadBeneficiario extends CActiveRecord
{
	...
	{
		return 'tblc_unidad_beneficiario';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_unidad_beneficiario, nombre', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UnidadBeneficiario the static model class
	 */
