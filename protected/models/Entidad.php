...
/**
 * This is the model class for table "tblc_entidad".
 *
 * The followings are the available columns in table 'tblc_entidad':
...
class Entidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_entidad, clave, nombre', 'safe', 'on'=>'search'),
		);
	}
