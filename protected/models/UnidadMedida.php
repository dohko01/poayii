...
/**
 * This is the model class for table "tblc_unidad_medida".
 *
 * The followings are the available columns in table 'tblc_unidad_medida':
...
class UnidadMedida extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_unidad_medida, descripcion', 'safe', 'on'=>'search'),
		);
	}
