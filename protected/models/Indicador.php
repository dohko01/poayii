...
class Indicador extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_variable_denominador' => 'Denominador',
			'total' => 'Total',
			...
			'id_formula_indicador' => 'Formula',
			'id_tipo_indicador' => 'Tipo de Indicador',
			'id_frecuencia' => 'Frecuencia',
			'id_comportamiento' => 'Comportamiento',
			'id_dimension_indicador' => 'Dimension del Indicador',
			'id_variable_numerador' => 'Numerador',
		);
	}
