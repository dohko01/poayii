...
/**
 * This is the model class for table "tblc_finalidad".
 *
...
class Finalidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_finalidad, descripcion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Finalidad the static model class
	 */
