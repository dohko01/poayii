...
class ObjetivoIndicadorController extends Controller
{
	/**
	 ...
	 * @var string
	 */
	public $title_sin = 'ObjetivoIndicador';
	 ...
	 * @var string 
	 */
	public $title_plu = 'ObjetivoIndicador';
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('ObjetivoIndicador');
	...
	public function actionAdmin()
	{
		...
		$model=new ObjetivoIndicador('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ObjetivoIndicador']))
			$model->attributes=$_GET['ObjetivoIndicador'];
	 ...
	 * @return ObjetivoIndicador the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ObjetivoIndicador::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ObjetivoIndicador $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='objetivo-indicador-form')
		{
