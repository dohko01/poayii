...
class ProyectoInstitucionalController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('ProyectoInstitucional');
	...
	public function actionAdmin()
	{
		...
		$model=new ProyectoInstitucional('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProyectoInstitucional']))
			$model->attributes=$_GET['ProyectoInstitucional'];
	 ...
	 * @return ProyectoInstitucional the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ProyectoInstitucional::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ProyectoInstitucional $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='proyecto-institucional-form')
		{
