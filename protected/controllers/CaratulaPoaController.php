...
class CaratulaPoaController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new CaratulaPoa;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['CaratulaPoa']))
		{
			$model->attributes=$_POST['CaratulaPoa'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_caratula_poa));
		}
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('CaratulaPoa');
	 ...
	 * @return CaratulaPoa the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=CaratulaPoa::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CaratulaPoa $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='caratula-poa-form')
		{
