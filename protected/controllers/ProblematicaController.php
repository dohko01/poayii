...
//				$this->redirect(array('view','id'=>$model->id_problematica));
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Problematica');
	...
	public function actionAdmin()
	{
		...
		$model=new Problematica('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Problematica']))
			$model->attributes=$_GET['Problematica'];
	 ...
	 * @return Problematica the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Problematica::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Problematica $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='problematica-form')
		{
